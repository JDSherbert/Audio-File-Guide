...
| Mozilla                                                                                                                                                              | .wav, .mp3, .ogg, .flac, .aac, .opus, .m4a, .midi   |
| <a href = ""> <img align="left" img height="40" img width="40" src="https://cdn.simpleicons.org/chromium">                                                           | .wav, .mp3, .ogg, .flac, .aac, .opus, .m4a, .midi   |
| Edge                                                                                                                                                                 | .wav, .mp3, .ogg, .flac, .aac, .opus, .m4a, .midi   |
| Safari                                                                                                                                                               | .wav, .mp3, .aiff, .alac, .aac, .m4a  |
